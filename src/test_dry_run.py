...
def build_fake_match_payload() -> dict:
    ...
    return {
        ...
        "surface_stats_a": fetch_data.compute_surface_stats(history, TEST_PLAYER_A, TEST_SURFACE),
        "surface_stats_b": fetch_data.compute_surface_stats(history, TEST_PLAYER_B, TEST_SURFACE),
        "fatigue_signal_a": fetch_data.compute_fatigue(history, TEST_PLAYER_A, start, 4),
        "fatigue_signal_b": fetch_data.compute_fatigue(history, TEST_PLAYER_B, start, 4),
