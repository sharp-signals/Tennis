...
@media(max-width:900px){.shell{grid-template-columns:1fr}.status-strip{grid-template-columns:1fr}.green-money-hero .metrics{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:560px){.dashboard-legend{display:grid;grid-template-columns:1fr}.legend-item{border-radius:10px}.flat-sim{padding:12px}.help-copy{font-size:12px}.panel-guide{max-width:none}.green-money-hero{padding:16px}.green-money-head{display:block}.green-money-status{display:inline-flex;margin-top:9px}.green-money-result{font-size:42px}.green-money-hero .metrics{grid-template-columns:1fr 1fr}}
"""
