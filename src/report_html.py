...
@media(max-width:640px){.mh{padding:18px 14px}.mh-name{font-size:20px}.mh-top{gap:7px}.mh-tourn{font-size:9px}.mh-context{font-size:10px}.keys{grid-template-columns:1fr}.glance-head,.glance-row{grid-template-columns:1fr 100px 1fr}.pulse-player{grid-template-columns:1fr;gap:7px}.pulse-seq{justify-content:flex-start;width:100%}}
"""
